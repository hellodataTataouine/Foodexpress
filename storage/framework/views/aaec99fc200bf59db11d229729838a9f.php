                  ...
                  <div class="card-body">
                   ...
                   <form method="POST" action="<?php echo e(route('restaurant.servicezone.store')); ?>">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" type="number" placeholder="Example 75000"  min="0" max="100000" id="postal_code" name="postal_code" required/>
                        </div>
                        <div class="mb-3">
                            <label for="mincmd" class="form-label">Montant minimal requis pour une commande</label>
                            <input class="form-control" type="number" placeholder="Example 50.0" step="0.01" min="0" max="100000" id="mincmd" name="mincmd" required/>
                        </div>
