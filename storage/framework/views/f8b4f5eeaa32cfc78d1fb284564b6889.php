                            ...
                            <div class="card">
                                ...
                                <?php endif; ?>
                                    <div class="table-responsive">
                                        <form action="<?php echo e(route('restaurant.produits.store')); ?>" method="POST"
                                                ...
                                                <select name="categorie_rest_id" class="form-control" required>
                                                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($category->id); ?>"
                                                            <?php echo e(request()->input('categorie_rest_id') == $category->id ? 'selected' : ''); ?>>
...
<?php echo $__env->make('base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HD FRONT\laravel\Foodexpress\resources\views/restaurant/produits/create.blade.php ENDPATH**/ ?>