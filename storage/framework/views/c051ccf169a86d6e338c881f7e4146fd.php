...
<?php if($reservation == 1): ?>
    ...
    <li class="nav-item menu-items livraison">
        ...
        <ul class="nav flex-column sub-menu">
          <li class="nav-item"> <a class="nav-link" href="<?php echo e(route('restaurant.livraison.index')); ?>">Liste de Méthode Livraisons</a></li>
          <li class="nav-item"> <a class="nav-link" href="<?php echo e(route('restaurant.livraison.create')); ?>">Ajouter Méthode Livraison</a></li>
          </ul>
        </div>
    </li>
    <li class="nav-item menu-items">
      <a class="nav-link"  href="<?php echo e(route ('restaurant.metadata.create')); ?>">
        <span class="menu-icon">
    ...
    <li class="nav-item menu-items">
      ...
      <div class="collapse" id="zoneserv">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item"> <a class="nav-link" href="<?php echo e(route ('restaurant.servicezone.index')); ?>">Liste Zones de service</a></li>
          <li class="nav-item"> <a class="nav-link" href="<?php echo e(route ('restaurant.servicezone.create')); ?>">Ajouter une Zone de service</a></li>
