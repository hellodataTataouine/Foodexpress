                ...
                <div class="col-12 grid-margin">
                  <div class="card">
                    <div class="card-body">
                      ...
                      <?php endif; ?>
                      <form action="<?php echo e(route('restaurant.servicezone.update', $postalcode)); ?>" method="POST">
                          <?php echo csrf_field(); ?>
                          <?php echo method_field('PUT'); ?>
                        <div class="mb-3">
                            <label for="postalcode" class="form-label">Code postale</label>
                            <input class="form-control" type="number" placeholder="Example 75000"  min="0" max="100000" id="postalcode" name="postal_code" value="<?php echo e($postalcode->postal_code); ?>"/>
                        </div>
                        <div class="mb-3">
                            <label for="mincmd" class="form-label">Montant minimal requis pour une commande</label>
                            <input class="form-control" type="number" placeholder="Example 50.0"  min="0" max="100000" id="mincmd" name="mincmd" value="<?php echo e($postalcode->min_cmd); ?>"/>
                        </div>
