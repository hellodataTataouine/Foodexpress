                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <form action="{{ route('admin.restaurant.livraison.store') }}" method="POST">
                                            @csrf
                                            ...
                                            <div class="form-group">
                                                <label for="livraison_id">Nom Livraison Method </label>
                                            ...
                                            <button type="submit" class="btn btn-primary">Ajouter livraison Restaurant</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
