          ...
          <div class="content-wrapper">
            ...
            <div class="row ">
                <div class="col-12 grid-margin">
                  <div class="card">
                    <div class="card-body">
                      <h4 class="card-title">Modifier Paiment Methode</h4>
                      @if (session('success'))
                          <div class="alert alert-success">
                              {{ session('success') }}
                          </div>
                      @endif
                      <form action="{{ route('admin.paiment.update', $paimentRestaurant->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <button type="submit" class="btn btn-primary">mettre à jour Paiment Restaurant</button>
                    </form>
                    </div>
                  </div>
                </div>
