                  ...
                  <div class="card-body">
                   ...
                   <form method="POST" action="{{ route('restaurant.seo.update',$metadata->id) }}" enctype="multipart/form-data" style="width: 90%;">
                          ...
                          <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="title" id="title" maxlength="70" placeholder="Le titre doit contenir moins de 70 caractères" value="{{ $metadata->title }}" required>
                        </div>
                        <div class="flex-container">
                          <div class="mb-3" style="width: 50%; margin-right: 5px;">
                            <label for="description" class="form-label">Description</label>
                            <textarea class="form-control" id="description" name="description" rows="3" maxlength="150" placeholder="La description doit contenir moins de 150 caractères"  required >{{ $metadata->description }}</textarea>
                        </div>
                        <div class="mb-3" style="width: 50%; margin-left: 5px;">
                            ...
                            <textarea class="form-control" id="keywords" name="keywords" rows="3" placeholder="mot-clé 1 , mot-clé 2 , mot-clé 3 ..." required>{{ $metadata->keywords }}</textarea>
                        </div>
                        </div>
                        <div class="flex-container">
                          <div class="mb-3" style="width: 50%; margin-right: 5px;">
                            ...
                            <select class="form-control" id="robots" name="robots">
                                ...
                                @else
                                    ...
                                    <option selected value="noindex">No</option>
                                @endif
