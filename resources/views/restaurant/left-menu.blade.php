    ...
    <ul class="nav">
      ...
      <form id="statusForm">
        ...
        <label style="color: white; margin-left: 20px;">
            <input type="radio" name="staus" value="1" {{ $status->available == 1 ? 'checked' : '' }} onchange="updateStatus(this)">
            Disponible
        </label>
        <label style="color: white; margin-left: 20px;">
            <input type="radio" name="staus" value="0" {{ $status->available == 0 ? 'checked' : '' }} onchange="updateStatus(this)">
            Non Disponible
        </label>
...
@if($reservation == 1)
    ...
    <li class="nav-item menu-items">
        <a class="nav-link"  href="{{ route ('restaurant.visits.index') }}">
          <span class="menu-icon">
