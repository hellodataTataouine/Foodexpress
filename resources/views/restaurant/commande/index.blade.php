                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                            ...
                                            <tbody>
                                                @foreach($produits as $produit)
                                                    <tr>
                                                        ...
                                                        <td>
                                                          @if($produit->status == 1)
                                                              <button class="btn btn-success btn-sm status-toggle-btn" data-id="{{ $produit->id }}" data-status="1">Active</button>
                                                          @else
                                                              <button class="btn btn-danger btn-sm status-toggle-btn" data-id="{{ $produit->id }}" data-status="0">Inactive</button>
                                                          @endif
                                                      </td>
                                                        ...
                                                        <td style="display: flex;">
                                                            ...
                                                            <form
                                                                ...
                                                                @method('DELETE')
                                                                <button type="submit"
                                                                    class="btn btn-danger col">Delete</button>
                                                            </form>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                        ...
                                        <div class="pagination justify-content-between">
                                          <div class="text-end">
                                            <a href="{{ route('restaurant.produits.create') }}" class="btn btn-primary">Create Product</a>
                                          </div>
